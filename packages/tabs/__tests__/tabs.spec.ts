    ...
    const wrapper = mount({
      ...
      template: `
        <el-tabs :active-name="activeName" @tab-click="handleClick">
          <el-tab-pane name="a" label="用户管理">A</el-tab-pane>
          <el-tab-pane name="b" label="配置管理">B</el-tab-pane>
          <el-tab-pane name="c" label="角色管理" ref="pane-click">C</el-tab-pane>
          <el-tab-pane name="d" label="定时任务补偿">D</el-tab-pane>
        </el-tabs>
      `,
    })
